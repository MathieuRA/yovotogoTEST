...
DROP TABLE IF EXISTS `yovo_aiowps_login_activity`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `yovo_aiowps_login_activity` (
...
LOCK TABLES `yovo_aiowps_login_activity` WRITE;
/*!40000 ALTER TABLE `yovo_aiowps_login_activity` DISABLE KEYS */;
/*!40000 ALTER TABLE `yovo_aiowps_login_activity` ENABLE KEYS */;
UNLOCK TABLES;
