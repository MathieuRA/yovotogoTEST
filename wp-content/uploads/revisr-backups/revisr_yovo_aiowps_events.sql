...
DROP TABLE IF EXISTS `yovo_aiowps_events`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `yovo_aiowps_events` (
...
LOCK TABLES `yovo_aiowps_events` WRITE;
/*!40000 ALTER TABLE `yovo_aiowps_events` DISABLE KEYS */;
/*!40000 ALTER TABLE `yovo_aiowps_events` ENABLE KEYS */;
UNLOCK TABLES;
